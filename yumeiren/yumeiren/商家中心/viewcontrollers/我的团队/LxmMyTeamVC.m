...
- (void)setOtherInfoModel:(LxmSeeOtherInfoModel *)otherInfoModel {
    ...
    if ([_otherInfoModel.roleType isEqualToString:@"-0.5"]){
        ...
        [_bottomView1.roleButton setTitle:@"减肥单项-总经理" forState:UIControlStateNormal];
    } else if ([_otherInfoModel.roleType isEqualToString:@"2.1"]) {
        [_bottomView1.roleButton setTitle:@"减肥单项-董事" forState:UIControlStateNormal];
        ...
        switch (_otherInfoModel.roleType.intValue) {
            ...
            case 0:
                ...
                break;
            case 1:
                [_bottomView1.roleButton setTitle:@"经理" forState:UIControlStateNormal];
                break;
            case 2:
                [_bottomView1.roleButton setTitle:@"总经理" forState:UIControlStateNormal];
                break;
            case 3:
                [_bottomView1.roleButton setTitle:@"董事" forState:UIControlStateNormal];
                break;
            case 4:
