...
- (void)loadUserInfo {
    [SVProgressHUD show];
    WeakObj(self);
    [LxmNetworking networkingPOST:other_infoNew parameters:@{@"token":SESSION_TOKEN,@"userId":self.model.id} returnClass:LxmSeeOtherInfoRootModel.class success:^(NSURLSessionDataTask *task, LxmSeeOtherInfoRootModel *responseObject) {
